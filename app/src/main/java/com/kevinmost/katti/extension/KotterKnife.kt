...
// Copied from KotterKnife because having ButterKnife and KotterKnife in the same project was
// causing dex-merging issues (probably because Jake called the file "ButterKnife.kt" in his
// KotterKnife library, resulting in file-clashes)
